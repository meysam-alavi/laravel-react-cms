INSERT INTO `countries` (`country_id`, `name_en`, `currency_code`, `fips_code`, `iso_numeric`, `north`,
                         `south`, `east`, `west`, `capital`, `continent_name`, `continent_id`, `languages`,
                         `iso_alpha3`, `geo_name_id`)
VALUES
