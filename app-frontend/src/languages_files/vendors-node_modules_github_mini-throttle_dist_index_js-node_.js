...
(() => {
    ...
    var c = (x, C) => D(x, "name", {value: C, configurable: !0});
    (globalThis.webpackChunk = globalThis.webpackChunk || []).push([["vendors-node_modules_github_mini-throttle_dist_index_js-node_modules_github_hotkey_dist_index-9f48bd"], {
        46263: (x, C, N) => {
            N.d(C, {D: () => b, P: () => p});

            function p(_, m = 0, {start: y = !0, middle: u = !0, once: w = !1} = {}) {
                let h = 0, l, f = !1;

                function v(...k) {
                    if (f) return;
                    const T = Date.now() - h;
                    h = Date.now(), y ? (y = !1, _.apply(this, k), w && v.cancel()) : (u && T < m || !u) && (clearTimeout(l), l = setTimeout(() => {
                        h = Date.now(), _.apply(this, k), w && v.cancel()
                    }, u ? m - T : m))
                }
            ...
            function b(_, m = 0, {start: y = !1, middle: u = !1, once: w = !1} = {}) {
                return p(_, m, {start: y, middle: u, once: w})
            }

            c(b, "debounce")
        }, 11793: (x, C, N) => {
            N.d(C, {EL: () => u, N9: () => W, Tz: () => S});
            ...
            class b {
                ...
                delete(o) {
                    for (const r in this.children) if (this.children[r] === o) {
            ...
            function _(a) {
                ...
                const o = a.nodeName.toLowerCase(), r = (a.getAttribute("type") || "").toLowerCase();
            ...
            function m(a, o) {
                const r = new CustomEvent("hotkey-fire", {cancelable: !0, detail: {path: o}});
                !a.dispatchEvent(r) || (_(a) ? a.focus() : a.click())
            }
            ...
            function u(a) {
                const {ctrlKey: o, altKey: r, metaKey: g, key: d} = a, n = [], e = [o, r, g, h(a)];
                for (const [t, i] of e.entries()) i && n.push(w[t]);
                return w.includes(d) || n.push(d), n.join("+")
            }

            c(u, "hotkey");
            const w = ["Control", "Alt", "Meta", "Shift"];

            function h(a) {
                const {shiftKey: o, code: r, key: g} = a;
                return o && !(r.startsWith("Key") && g.toUpperCase() === g)
            }

            c(h, "showShift");
            const l = new b, f = new WeakMap;
            let v = l, k = null, T = [];
            ...
            function S(a) {
                const o = f.get(a);
                if (o && o.length) for (const r of o) r && r.delete(a);
            ...
            class w {
                ...
                createEvent(l) {
                    return {page: location.href, title: document.title, context: {...this.options.baseContext, ...l}}
                }

                sendPageView(l) {
                    const f = this.createEvent(l);
                    this.send({page_views: [f]})
                }

                sendEvent(l, f) {
                    const v = {...this.createEvent(f), type: l};
                    this.send({events: [v]})
                }

                send({page_views: l, events: f}) {
                    const v = {client_id: this.clientId, page_views: l, events: f, request_context: y()},
                        k = JSON.stringify(v);
                    try {
            ...
            function _(u) {
                const w = `GH1.1.${u}`, h = Date.now(), l = new Date(h + 1 * 365 * 86400 * 1e3).toUTCString();
                let {domain: f} = document;
                f.endsWith(".github.com") && (f = "github.com"), document.cookie = `_octo=${w}; expires=${l}; path=/; domain=${f}; secure; samesite=lax`
            }

            c(_, "setClientIdCookie");
            ...
            function p(b = "ha") {
                let _;
                const m = {}, y = document.head.querySelectorAll(`meta[name^="${b}-"]`);
                for (const u of Array.from(y)) {
                    const {name: w, content: h} = u, l = w.replace(`${b}-`, "").replace(/-/g, "_");
                    l === "url" ? _ = h : m[l] = h
                }
                if (!_) throw new Error(`AnalyticsClient ${b}-url meta tag not found`);
                return {collectorUrl: _, ...Object.keys(m).length > 0 ? {baseContext: m} : {}}
            }

            c(p, "getOptionsFromMeta")
        }, 38772: (x, C, N) => {
            N.d(C, {dy: () => o, sY: () => r, Au: () => n});
            var p = N(69567);
            const b = new WeakSet;
            ...
            class w {
                ...
                static for(t) {
                    ...
                    const i = t.attributeName.slice(2), s = u.get(t.element);
                    return s.has(i) ? s.get(i) : new w(t.element, i)
                }
            ...
            function h(e, t) {
                return e instanceof p.sV && e.attributeName.startsWith("on") ? (w.for(e).set(t), e.element.removeAttributeNS(e.attributeNamespace, e.attributeName), !0) : !1
            }
            ...
            function k(e, t) {
                ...
                if (e instanceof p.GZ) {
                    const i = [];
                    for (const s of t) if (s instanceof S) {
            ...
            c(T, "processPart");
            const P = new WeakMap, I = new WeakMap, W = new WeakMap;
            ...
            class S {
                ...
                get template() {
                    ...
                    {
                        const t = document.createElement("template"), i = this.strings.length - 1;
            ...
            c(r, "render");
            const g = new WeakMap, d = y((...e) => t => {
                g.has(t) || g.set(t, {i: e.length});
                const i = g.get(t);
            ...
            N.d(C, {sV: () => u, GZ: () => v, R: () => d, AQ: () => k, W_: () => P, Al: () => T, XK: () => W});
            ...
            function* p(n) {
                ...
                e && (yield{type: "string", start: t, end: n.length, value: e})
            }
            ...
            class u {
                constructor(e, t) {
                    this.expression = t, m.set(this, void 0), y.set(this, ""), b(this, m, e), _(this, m).updateParent("")
                }

                get attributeName() {
                    return _(this, m).attr.name
                }

                get attributeNamespace() {
                    return _(this, m).attr.namespaceURI
                }
                ...
                set value(e) {
                    b(this, y, e || ""), _(this, m).updateParent(e)
                }

                get element() {
                    return _(this, m).element
                }

                get booleanValue() {
                    return _(this, m).booleanValue
                }

                set booleanValue(e) {
                    _(this, m).booleanValue = e
                }
            }
            ...
            class w {
                ...
                updateParent(e) {
                    if (this.partList.length === 1 && e === null) this.element.removeAttributeNS(this.attr.namespaceURI, this.attr.name); else {
                ...
                return {
                    createCallback(e, t, i) {
                        ...
                        if (!(typeof i != "object" || !i)) {
                            for (const E of t) if (E.expression in i) {
            ...
            function* g(n) {
                ...
                let t;
                for (; t = e.nextNode();) if (t instanceof Element && t.hasAttributes()) for (let i = 0; i < t.attributes.length; i += 1) {
                    const s = t.attributes.item(i);
                    if (s && s.value.includes("{{")) {
                        const E = new w(t, s);
                        for (const F of p(s.value)) if (F.type === "string") E.append(F.value); else {
                            const A = new u(E, F.value);
                            E.append(A), yield A
                        }
                    }
                } else if (t instanceof Text && t.textContent && t.textContent.includes("{{")) for (const i of p(t.textContent)) {
