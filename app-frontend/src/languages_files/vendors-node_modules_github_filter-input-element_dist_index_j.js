...
(() => {
    ...
    var o = (D, x) => W(D, "name", {value: x, configurable: !0});
    (globalThis.webpackChunk = globalThis.webpackChunk || []).push([["vendors-node_modules_github_filter-input-element_dist_index_js-node_modules_github_remote-inp-c7e9ed"], {
        13002: (D, x, M) => {
            M.d(x, {Z: () => d});
            ...
            class v extends HTMLElement {
                constructor() {
                    super();
                    this.currentQuery = null, this.filter = null, this.debounceInputChange = _(() => u(this, !0)), this.boundFilterResults = () => {
                        u(this, !1)
                    }
                }
                ...
                reset() {
                    const n = this.input;
                    n && (n.value = "", n.dispatchEvent(new Event("change", {bubbles: !0})))
                }
            }
            ...
            async function u(e, n = !1) {
                const t = e.input;
                if (!t) return;
                const a = t.value.trim(), l = e.getAttribute("aria-owns");
                if (!l) return;
                const r = document.getElementById(l);
                if (!r) return;
                const c = r.hasAttribute("data-filter-list") ? r : r.querySelector("[data-filter-list]");
                if (!c || (e.dispatchEvent(new CustomEvent("filter-input-start", {bubbles: !0})), n && e.currentQuery === a)) return;
                e.currentQuery = a;
                const m = e.filter || S, A = c.childElementCount;
                let h = 0, k = !1;
                for (const g of Array.from(c.children)) {
                    if (!(g instanceof HTMLElement)) continue;
                    const L = w(g), R = m(g, L, a);
                    R.hideNew === !0 && (k = R.hideNew), g.hidden = !R.match, R.match && h++
                }
                const b = r.querySelector("[data-filter-new-item]"), E = !!b && a.length > 0 && !k;
                b instanceof HTMLElement && (b.hidden = !E, E && p(b, a)), y(r, h > 0 || E), e.dispatchEvent(new CustomEvent("filter-input-updated", {
                    bubbles: !0,
                    detail: {count: h, total: A}
                }))
            }
            ...
            function S(e, n, t) {
                return {match: n.toLowerCase().indexOf(t.toLowerCase()) !== -1, hideNew: n === t}
            }
            ...
            class u extends HTMLElement {
                constructor() {
                    ...
                    const e = w.bind(null, this, !0),
                        n = {currentQuery: null, oninput: y(e), fetch: e, controller: null};
                    v.set(this, n)
                }
            ...
            async function w(d, e) {
                ...
                if (!r) return;
                const c = new URL(l, window.location.href), m = new URLSearchParams(c.search);
                ...
                A && A.ok ? (r.innerHTML = h, d.dispatchEvent(new CustomEvent("remote-input-success", {bubbles: !0}))) : d.dispatchEvent(new CustomEvent("remote-input-error", {bubbles: !0}))
            }
            ...
            class u extends HTMLElement {
                constructor() {
                    ...
                    this.addEventListener("keydown", p => {
                        const y = p.target;
                        if (!(y instanceof HTMLElement) || y.closest(this.tagName) !== this || y.getAttribute("role") !== "tab" && !y.closest('[role="tablist"]')) return;
                        const _ = v(this), d = _.indexOf(_.find(e => e.matches('[aria-selected="true"]')));
                        if (p.code === "ArrowRight") {
                            let e = d + 1;
                            e >= _.length && (e = 0), S(this, e)
                        } else if (p.code === "ArrowLeft") {
                            let e = d - 1;
                            e < 0 && (e = _.length - 1), S(this, e)
                        } else p.code === "Home" ? (S(this, 0), p.preventDefault()) : p.code === "End" && (S(this, _.length - 1), p.preventDefault())
                    }), this.addEventListener("click", p => {
                        const y = v(this);
                        if (!(p.target instanceof Element) || p.target.closest(this.tagName) !== this) return;
                        const _ = p.target.closest('[role="tab"]');
                        if (!(_ instanceof HTMLElement) || !_.closest('[role="tablist"]')) return;
                        const d = y.indexOf(_);
                        S(this, d)
                    })
                }
            ...
            function S(w, p) {
                const y = v(w),
                    _ = Array.from(w.querySelectorAll('[role="tabpanel"]')).filter(t => t.closest(w.tagName) === w),
                    d = y[p], e = _[p];
                if (!!w.dispatchEvent(new CustomEvent("tab-container-change", {
                    ...
                    for (const t of y) t.setAttribute("aria-selected", "false"), t.setAttribute("tabindex", "-1");
                    for (const t of _) t.hidden = !0, !t.hasAttribute("tabindex") && !t.hasAttribute("data-tab-container-no-tabstop") && t.setAttribute("tabindex", "0");
            ...
            M.d(x, {CD: () => A, Gs: () => c, m7: () => m});
            var v = -1 / 0, u = 1 / 0, S = -.005, w = -.005, p = -.01, y = 1, _ = .9, d = .8, e = .7, n = .6;
            ...
            function l(h) {
                for (var k = h.length, b = new Array(k), E = "/", g = 0; g < k; g++) {
                    var L = h[g];
                    E === "/" ? b[g] = _ : E === "-" || E === "_" || E === " " ? b[g] = d : E === "." ? b[g] = n : t(E) && a(L) ? b[g] = e : b[g] = 0, E = L
                }
                return b
            }
            ...
            function r(h, k, b, E) {
                for (var g = h.length, L = k.length, R = h.toLowerCase(), O = k.toLowerCase(), I = l(k, I), T = 0; T < g; T++) {
                    b[T] = new Array(L), E[T] = new Array(L);
                    for (var q = v, P = T === g - 1 ? w : p, H = 0; H < L; H++) if (R[T] === O[H]) {
                        var i = v;
                        T ? H && (i = Math.max(E[T - 1][H - 1] + I[H], b[T - 1][H - 1] + y)) : i = H * S + I[H], b[T][H] = i, E[T][H] = q = Math.max(i, q + P)
                    } else b[T][H] = v, E[T][H] = q = q + P
                }
            }
            ...
            function c(h, k) {
                var b = h.length, E = k.length;
                if (!b || !E) return v;
                if (b === E) return u;
                if (E > 1024) return v;
                var g = new Array(b), L = new Array(b);
            ...
            function m(h, k) {
                var b = h.length, E = k.length, g = new Array(b);
                if (!b || !E) return g;
                if (b === E) {
                ...
                if (E > 1024) return g;
                var R = new Array(b), O = new Array(b);
                r(h, k, R, O);
                for (var I = !1, L = b - 1, T = E - 1; L >= 0; L--) for (; T >= 0; T--) if (R[L][T] !== v && (I || R[L][T] === O[L][T])) {
                    I = L && T && O[L][T] === R[L - 1][T - 1] + y, g[L] = T--;
                    break
                }
                return g
            }
            ...
            function A(h, k) {
                ...
                for (var b = h.length, E = 0, g = 0; E < b; E += 1) if (g = k.indexOf(h[E], g) + 1, g === 0) return !1;
                return !0
            }
            ...
            function p(l, r) {
                ...
                return c.open("GET", r, !0), c.setRequestHeader("Accept", "text/fragment+html"), y(l, c)
            }
            ...
            function y(l, r) {
                const c = w.get(l);
                c && c.abort(), w.set(l, r);
                const m = o(() => w.delete(l), "clear"), A = _(r);
                return A.then(m, m), A
            }
            ...
            class e {
                ...
                onKeydown(r) {
                    if (r.key === "Enter" && this.container.open && this.autoselectEnabled) {
                        ...
                        c && (r.stopPropagation(), r.preventDefault(), this.onCommit({target: c}))
                    }
                    if (r.key === "Escape" && this.container.open) this.container.open = !1, r.stopPropagation(), r.preventDefault(); else if (r.altKey && r.key === "ArrowUp" && this.container.open) this.container.open = !1, r.stopPropagation(), r.preventDefault(); else if (r.altKey && r.key === "ArrowDown" && !this.container.open) {
                ...
                fetchResults() {
                    ...
                    if (!c) return;
                    const m = new URL(c, window.location.href), A = new URLSearchParams(m.search.slice(1));
                    A.append("q", r), m.search = A.toString(), this.container.dispatchEvent(new CustomEvent("loadstart")), p(this.input, m.toString()).then(h => {
                        ...
                        const k = this.results.querySelectorAll('[role="option"]'), b = !!k.length,
                            E = k.length, [g] = k, L = g == null ? void 0 : g.textContent;
            ...
            class t extends HTMLElement {
                ...
                connectedCallback() {
                    ...
                    if (!r) return;
                    const c = this.querySelector("input"), m = document.getElementById(r);
            ...
            class u {
                ...
                navigate(a = 1) {
                    const l = Array.from(this.list.querySelectorAll('[aria-selected="true"]')).filter(_)[0],
                        r = Array.from(this.list.querySelectorAll('[role="option"]')).filter(_), c = r.indexOf(l);
                    ...
                    const A = r[m];
                    if (!!A) for (const h of r) A === h ? (this.input.setAttribute("aria-activedescendant", A.id), A.setAttribute("aria-selected", "true"), e(this.list, A)) : h.setAttribute("aria-selected", "false")
                }
            ...
            function w(t) {
                ...
                !a || a.getAttribute("aria-disabled") !== "true" && y(a)
            }
            ...
            function n(t, a) {
                const l = t.scrollTop, r = l + t.clientHeight, c = a.offsetTop, m = c + a.clientHeight;
                return c >= l && m <= r
            }
            ...
            M.d(x, {Z: () => d});
            const v = new WeakMap, u = new IntersectionObserver(e => {
            ...
            function p(e) {
                const n = e.src;
                let t = v.get(e);
                return t && t.src === n ? t.data : (n ? t = y(e) : t = Promise.reject(new Error("missing src")), v.set(e, {
                    src: n,
                    data: t
                }), t)
            }
            ...
            function y(e) {
                return S().then(() => (e.dispatchEvent(new Event("loadstart")), e.fetch(e.request()))).then(n => {
                    ...
                    if (!_(e.accept) && (!t || !t.includes(e.accept ? e.accept : "text/html"))) throw new Error(`Failed to load resource: expected ${e.accept || "text/html"} but was ${t}`);
                    return n.text()
                }).then(n => (S().then(() => {
      ...
      <slot></slot>`
            ...
            function w(i, s, f) {
                v.set(i, {
                    sortStarted: s,
                    sortFinished: f
                }), i.addEventListener("dragstart", _), i.addEventListener("dragenter", d), i.addEventListener("dragend", n), i.addEventListener("drop", e), i.addEventListener("dragover", t)
            }
            ...
            function _(i) {
                ...
                const C = Array.from(s.parentElement.children), F = C.indexOf(s), B = v.get(s);
                B && B.sortStarted(f), u = {
                    didDrop: !1,
                    dragging: s,
                    dropzone: s,
            ...
            function e(i) {
                ...
                const F = {list: u.sourceList, index: u.sourceIndex}, B = {list: C, index: f}, N = v.get(u.dragging);
                N && N.sortFinished({src: F, dst: B})
            }
                ...
                connectedCallback() {
                    this.addEventListener("change", f => {
                        ...
                        C instanceof HTMLInputElement && (!C.classList.contains("task-list-item-checkbox") || this.dispatchEvent(new CustomEvent("task-lists-check", {
                            bubbles: !0,
                            detail: {position: k(C), checked: C.checked}
                        })))
                    });
                    const s = new MutationObserver(L.bind(null, this));
                    a.set(this, s), s.observe(this, {childList: !0, subtree: !0}), L(this)
                }
    ...
    <svg class="drag-handle" aria-hidden="true" width="16" height="16">
      <path d="M10 13a1 1 0 100-2 1 1 0 000 2zm-4 0a1 1 0 100-2 1 1 0 000 2zm1-5a1 1 0 11-2 0 1 1 0 012 0zm3 1a1 1 0 100-2 1 1 0 000 2zm1-5a1 1 0 11-2 0 1 1 0 012 0zM6 5a1 1 0 100-2 1 1 0 000 2z"/>
            ...
            function m(i) {
                ...
                const f = r.content.cloneNode(!0), C = f.querySelector(".handle");
                if (i.prepend(f), !C) throw new Error("handle not found");
                C.addEventListener("mouseenter", P), C.addEventListener("mouseleave", H), w(i, T, q), i.addEventListener("mouseenter", A), i.addEventListener("mouseleave", h)
            }
            ...
            function k(i) {
                ...
                const f = i.closest(".task-list-item"), C = Array.from(s.children).filter(B => B.tagName === "LI"),
                    F = f ? C.indexOf(f) : -1;
                return [O(s), F]
            }
