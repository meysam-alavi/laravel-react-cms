...
(() => {
    ...
    var i = (I, _) => B(I, "name", {value: _, configurable: !0});
    (globalThis.webpackChunk = globalThis.webpackChunk || []).push([["vendors-node_modules_github_catalyst_lib_index_js-node_modules_github_time-elements_dist_index_js"], {
        90420: (I, _, L) => {
            L.d(_, {Lj: () => Y, Ih: () => T, fA: () => P, GO: () => U});
            const F = new WeakSet;
            ...
            function b(e = document) {
                ...
                const a = new MutationObserver(m => {
                    for (const n of m) if (n.type === "attributes" && n.target instanceof Element) M(n.target); else if (n.type === "childList" && n.addedNodes.length) for (const t of n.addedNodes) t instanceof Element && p(t)
                });
                a.observe(e, {childList: !0, subtree: !0, attributeFilter: ["data-action"]});
                const l = {
                    get closed() {
                        return o
                    }, unsubscribe() {
            ...
            function z(e) {
                ...
                for (const a of D(o)) if (e.type === a.type) {
            ...
            function* D(e) {
                for (const o of (e.getAttribute("data-action") || "").trim().split(/\s+/)) {
                    const a = o.lastIndexOf(":"), l = Math.max(0, o.lastIndexOf("#")) || o.length;
                    yield{type: o.slice(0, a), tag: o.slice(a + 1, l), method: o.slice(l + 1) || "handleEvent"}
                }
            }
            ...
            function M(e) {
                for (const o of D(e)) e.addEventListener(o.type, z)
            }
            ...
            function N(e, o) {
                ...
                if (e.shadowRoot) {
                    for (const l of e.shadowRoot.querySelectorAll(`[data-target~="${a}.${o}"]`)) if (!l.closest(a)) return l
                }
                for (const l of e.querySelectorAll(`[data-target~="${a}.${o}"]`)) if (l.closest(a) === e) return l
            }

            i(N, "findTarget");

            function q(e, o) {
                const a = e.tagName.toLowerCase(), l = [];
                if (e.shadowRoot) for (const m of e.shadowRoot.querySelectorAll(`[data-targets~="${a}.${o}"]`)) m.closest(a) || l.push(m);
            ...
            function C(e) {
                for (const o of e.querySelectorAll("template[data-shadowroot]")) o.parentElement === e && e.attachShadow({mode: o.getAttribute("data-shadowroot") === "closed" ? "closed" : "open"}).append(o.content.cloneNode(!0))
            }
            ...
            function h(e, o) {
                e.toggleAttribute("data-catalyst", !0), customElements.upgrade(e), y.add(e), C(e), R(e), v(e), o && o.call(e), e.shadowRoot && g(e.shadowRoot)
            }

            i(h, "initializeInstance");
            ...
            function w(n, t) {
                const r = n.getDay(), s = n.getDate(), c = n.getMonth(), u = n.getFullYear(), d = n.getHours(),
                    f = n.getMinutes(), $ = n.getSeconds();
            ...
            i(b, "makeFormatter");
            let p = null;
            const z = b({day: "numeric", month: "short"});
            ...
            i(D, "isDayFirst");
            let M = null;
            const N = b({day: "numeric", month: "short", year: "numeric"});
            ...
            class A extends HTMLElement {
                ...
                attributeChangedCallback(t, r, s) {
                    ...
                    if (t === "datetime") {
                        const $ = Date.parse(s);
                        isNaN($) ? C.delete(this) : C.set(this, new Date($))
                    }
                    const u = this.getFormattedTitle(), d = this.getAttribute("title");
                    t !== "title" && u && (!d || d === c) && this.setAttribute("title", u);
                    const f = this.getFormattedDate();
                    f && (this.textContent = f)
                }
            ...
            class S extends A {
                attributeChangedCallback(t, r, s) {
                    (t === "hour" || t === "minute" || t === "second" || t === "time-zone-name") && R.delete(this), super.attributeChangedCallback(t, r, s)
                }

                getFormattedDate() {
                    const t = this.date;
                    if (!t) return;
                    const r = x(this, t) || "", s = H(this, t) || "";
                    return `${r} ${s}`.trim()
                }
            }
            ...
            function x(n, t) {
                ...
                let s = D() ? "weekday day month year" : "weekday month day, year";
                for (const c in r) {
            ...
            class y {
                ...
                timeElapsed() {
                    const t = new Date().getTime() - this.date.getTime(), r = Math.round(t / 1e3),
                        s = Math.round(r / 60), c = Math.round(s / 60), u = Math.round(c / 24);
                    return t >= 0 && u < 30 ? this.timeAgoFromMs(t) : null
                }

                timeAhead() {
                    const t = this.date.getTime() - new Date().getTime(), r = Math.round(t / 1e3),
                        s = Math.round(r / 60), c = Math.round(s / 60), u = Math.round(c / 24);
                ...
                timeAgoFromMs(t) {
                    const r = Math.round(t / 1e3), s = Math.round(r / 60), c = Math.round(s / 60),
                        u = Math.round(c / 24), d = Math.round(u / 30), f = Math.round(d / 12);
                    return t < 0 ? h(this.locale, 0, "second") : r < 10 ? h(this.locale, 0, "second") : r < 45 ? h(this.locale, -r, "second") : r < 90 ? h(this.locale, -s, "minute") : s < 45 ? h(this.locale, -s, "minute") : s < 90 ? h(this.locale, -c, "hour") : c < 24 ? h(this.locale, -c, "hour") : c < 36 ? h(this.locale, -u, "day") : u < 30 ? h(this.locale, -u, "day") : d < 18 ? h(this.locale, -d, "month") : h(this.locale, -f, "year")
                }

                microTimeAgo() {
                    const t = new Date().getTime() - this.date.getTime(), r = Math.round(t / 1e3),
                        s = Math.round(r / 60), c = Math.round(s / 60), u = Math.round(c / 24), d = Math.round(u / 30),
                        f = Math.round(d / 12);
                    return s < 1 ? "1m" : s < 60 ? `${s}m` : c < 24 ? `${c}h` : u < 365 ? `${u}d` : `${f}y`
                }
                ...
                timeUntilFromMs(t) {
                    const r = Math.round(t / 1e3), s = Math.round(r / 60), c = Math.round(s / 60),
                        u = Math.round(c / 24), d = Math.round(u / 30), f = Math.round(d / 12);
                    return d >= 18 ? h(this.locale, f, "year") : d >= 12 ? h(this.locale, f, "year") : u >= 45 ? h(this.locale, d, "month") : u >= 30 ? h(this.locale, d, "month") : c >= 36 ? h(this.locale, u, "day") : c >= 24 ? h(this.locale, u, "day") : s >= 90 ? h(this.locale, c, "hour") : s >= 45 ? h(this.locale, c, "hour") : r >= 90 ? h(this.locale, s, "minute") : r >= 45 ? h(this.locale, s, "minute") : r >= 10 ? h(this.locale, r, "second") : h(this.locale, 0, "second")
                }
                ...
                microTimeUntil() {
                    const t = this.date.getTime() - new Date().getTime(), r = Math.round(t / 1e3),
                        s = Math.round(r / 60), c = Math.round(s / 60), u = Math.round(c / 24), d = Math.round(u / 30),
                        f = Math.round(d / 12);
                    return u >= 365 ? `${f}y` : c >= 24 ? `${u}d` : s >= 60 ? `${c}h` : s > 1 ? `${s}m` : "1m"
                }
            ...
            function h(n, t, r) {
                const s = U(n, {numeric: "auto"});
                return s ? s.format(t, r) : O(t, r)
            }

            i(h, "formatRelativeTime");
            ...
            const Z = b({hour: "numeric", minute: "2-digit"});
            ...
            class l extends T {
                getFormattedDate() {
                    const t = this.getAttribute("format"), r = this.date;
