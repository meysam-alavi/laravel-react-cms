...
(() => {
    ...
    var s = (V, D) => ae(V, "name", {value: D, configurable: !0});
    (globalThis.webpackChunk = globalThis.webpackChunk || []).push([["vendors-node_modules_selector-observer_dist_index_esm_js"], {
        64463: (V, D, B) => {
            B.d(D, {N7: () => re});
            var w = B(8439), M = null, T = null, R = [];
            ...
            function N(e, t) {
                T || (T = new MutationObserver(L)), M || (M = e.createElement("div"), T.observe(M, {attributes: !0})), R.push(t), M.setAttribute("data-twiddle", "" + Date.now())
            }
            ...
            s(L, "handleMutations");
            var F = new WeakMap, E = new WeakMap, C = new WeakMap, A = new WeakMap;

            function a(e, t) {
                for (var n = 0; n < t.length; n++) {
                    var i = t[n], r = i[0], l = i[1], c = i[2];
                ...
                if (t instanceof e.elementConstructor) {
                    ...
                    if (!!n) {
                        ...
                        if (i !== -1 && e.elements.splice(i, 1), i = n.indexOf(e.id), i !== -1) {
                            var r = E.get(t), l = r ? r["" + e.id] : null;
                            if (l && l.remove && l.remove.call(void 0, t), e.subscribe) {
                                var c = C.get(t), x = c ? c["" + e.id] : null;
                ...
                if (!!n) {
                    for (var i = n.slice(0), r = 0; r < i.length; r++) {
                        ...
                        if (!!l) {
                            ...
                            var x = E.get(t), b = x ? x["" + l.id] : null;
                            b && b.remove && b.remove.call(void 0, t);
                            var O = C.get(t), k = O ? O["" + l.id] : null;
                            k && k.unsubscribe && k.unsubscribe(), l.remove && l.remove.call(void 0, t)
                        }
                    }
                    A.delete(t)
                }
            ...
            function m(e) {
                if (p === null) {
                    var t = e.createElement("div"), n = e.createElement("div"), i = e.createElement("div");
            ...
            function S(e, t, n) {
                for (var i = 0; i < n.length; i++) {
                    var r = n[i];
                    r.type === "childList" ? (I(e, t, r.addedNodes), U(e, t, r.removedNodes)) : r.type === "attributes" && _(e, t, r.target)
                }
            ...
            function I(e, t, n) {
                for (var i = 0; i < n.length; i++) {
                    var r = n[i];
                    if (y(r)) for (var l = e.selectorSet.matches(r), c = 0; c < l.length; c++) {
                        var x = l[c].data;
                        t.push([h, r, x])
                    }
                    if ("querySelectorAll" in r) for (var b = e.selectorSet.queryAll(r), O = 0; O < b.length; O++) for (var k = b[O], ie = k.data, K = k.elements, j = 0; j < K.length; j++) t.push([h, K[j], ie])
                }
            }
            ...
            function _(e, t, n) {
                if (y(n)) for (var i = e.selectorSet.matches(n), r = 0; r < i.length; r++) {
                    var l = i[r].data;
                    t.push([h, n, l])
                }
                if ("querySelectorAll" in n) {
                    var c = A.get(n);
                    if (c) for (var x = 0; x < c.length; x++) {
            ...
            s(_, "revalidateObservers");

            function Q(e, t, n) {
                if ("querySelectorAll" in n) {
                    _(e, t, n);
                    for (var i = n.querySelectorAll("*"), r = 0; r < i.length; r++) _(e, t, i[r])
                }
            }
            ...
            function Z(e, t, n) {
                for (var i = 0; i < n.length; i++) for (var r = n[i], l = r.form ? r.form.elements : e.rootNode.querySelectorAll("input"), c = 0; c < l.length; c++) _(e, t, l[c])
            }
            ...
            function G(e, t) {
                for (var n = 0; n < e.observers.length; n++) {
                    var i = e.observers[n];
                    if (i) for (var r = i.elements, l = 0; l < r.length; l++) {
                        var c = r[l];
            ...
            var M = window.document.documentElement,
                T = M.matches || M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector;
            ...
            w.prototype.indexes.push({
                name: "ID", selector: s(function (u) {
                    var o;
                    if (o = u.match(R)) return o[0].slice(1)
                }, "matchIdSelector"), element: s(function (u) {
                    if (u.id) return [u.id]
                }, "getElementId")
            });
            var P = /^\.((?:[\w\u00c0-\uFFFF\-]|\\.)+)/g;
            w.prototype.indexes.push({
                name: "CLASS", selector: s(function (u) {
                    var o;
                    if (o = u.match(P)) return o[0].slice(1)
                }, "matchClassSelector"), element: s(function (u) {
                    var o = u.className;
                    if (o) {
            ...
            var N = /^((?:[\w\u00c0-\uFFFF\-]|\\.)+)/g;
            w.prototype.indexes.push({
                name: "TAG", selector: s(function (u) {
                    var o;
                    if (o = u.match(N)) return o[0].toUpperCase()
                }, "matchTagSelector"), element: s(function (u) {
            ...
            function E(a, u) {
                ...
                var o = a.length, d, f, p, m, y = u, h, g, v = [];
                do if (F.exec(""), (p = F.exec(y)) && (y = p[3], p[2] || !y)) {
                    for (d = 0; d < o; d++) if (g = a[d], h = g.selector(p[1])) {
                        for (f = v.length, m = !1; f--;) if (v[f].index === g && v[f].key === h) {
                            m = !0;
                            break
                        }
                        m || v.push({index: g, key: h});
                        break
                    }
                } while (p);
                return v
            ...
            function C(a, u) {
                var o, d, f;
                for (o = 0, d = a.length; o < d; o++) if (f = a[o], u.isPrototypeOf(f)) return f
            }

            s(C, "findByPrototype"), w.prototype.logDefaultIndexUsed = function () {
            }, w.prototype.add = function (a, u) {
                var o, d, f, p, m, y, h, g, v = this.activeIndexes, S = this.selectors;
                if (typeof a == "string") {
                    for (o = {
                        id: this.uid++,
                        selector: a,
                        data: u
                    }, h = E(this.indexes, a), d = 0; d < h.length; d++) g = h[d], p = g.key, f = g.index, m = C(v, f), m || (m = Object.create(f), m.map = new L, v.push(m)), f === this.indexes.default && this.logDefaultIndexUsed(o), y = m.map.get(p), y || (y = [], m.map.set(p, y)), y.push(o);
                    this.size++, S.push(a)
                }
            }, w.prototype.remove = function (a, u) {
                if (typeof a == "string") {
                    var o, d, f, p, m, y, h, g, v = this.activeIndexes, S = {}, I = arguments.length === 1;
                    for (o = E(this.indexes, a), f = 0; f < o.length; f++) for (d = o[f], p = v.length; p--;) if (y = v[p], d.index.isPrototypeOf(y)) {
                        if (h = y.map.get(d.key), h) for (m = h.length; m--;) g = h[m], g.selector === a && (I || g.data === u) && (h.splice(m, 1), S[g.id] = !0);
                        break
                    }
            ...
            s(A, "sortById"), w.prototype.queryAll = function (a) {
                ...
                var u = {}, o = [], d = this.querySelectorAll(this.selectors.join(", "), a), f, p, m, y, h, g, v, S;
                for (f = 0, m = d.length; f < m; f++) for (h = d[f], g = this.matches(h), p = 0, y = g.length; p < y; p++) S = g[p], u[S.id] ? v = u[S.id] : (v = {
                    id: S.id,
                    selector: S.selector,
                    data: S.data,
                    elements: []
                ...
                if (!a) return [];
                var u, o, d, f, p, m, y, h, g, v, S, I = this.activeIndexes, U = {}, _ = [];
                for (u = 0, f = I.length; u < f; u++) if (y = I[u], h = y.element(a), h) {
                    for (o = 0, p = h.length; o < p; o++) if (g = y.map.get(h[o])) for (d = 0, m = g.length; d < m; d++) v = g[d], S = v.id, !U[S] && this.matchesSelector(a, v.selector) && (U[S] = !0, _.push(v))
                }
                return _.sort(A)
            }
        }
