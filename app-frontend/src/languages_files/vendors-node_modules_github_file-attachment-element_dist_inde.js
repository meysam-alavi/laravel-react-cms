...
(() => {
    ...
    var c = (j, P) => dt(j, "name", {value: P, configurable: !0});
    (globalThis.webpackChunk = globalThis.webpackChunk || []).push([["vendors-node_modules_github_file-attachment-element_dist_index_js-node_modules_primer_view-co-52e104"], {
        76745: (j, P, I) => {
            I.d(P, {Z: () => v});
            ...
            function S(d) {
                const t = d.getAttribute("for"), n = d.getAttribute("value");

                function a() {
                    d.dispatchEvent(new CustomEvent("clipboard-copy", {bubbles: !0}))
                }

                if (c(a, "trigger"), n) W(n).then(a); else if (t) {
            ...
            class x {
                ...
                static from(i) {
                    const f = [];
                    for (const E of i) if (E instanceof File) f.push(new x(E)); else if (E instanceof x) f.push(E); else throw new Error("Unexpected type");
                    return f
                }
            ...
            async function M(s, i) {
                const f = [];
                for (const E of S(i)) if (E.isDirectory) f.push(...await M(E.fullPath, await H(E))); else {
                    const L = await B(E);
                    f.push(new x(L, s))
                }
                return f
            ...
            function g(s) {
                for (const i of s) if (i.kind === "file" && h.test(i.type)) return i.getAsFile();
                return null
            }
            ...
            }, _ = {start: ["end", "center"], end: ["start", "center"], center: ["end", "start"]};

            function W(d, t, n = {}) {
                const a = S(d), h = B(a), g = getComputedStyle(a),
                    y = a.getBoundingClientRect(), [T, u] = [g.borderTopWidth, g.borderLeftWidth].map(i => parseInt(i, 10) || 0),
                    s = {top: y.top + T, left: y.left + u};
            ...
            function B(d) {
                ...
                const n = t === document.body || !(t instanceof HTMLElement) ? document.body : t,
                    ...
                    h = getComputedStyle(n), [g, y, T, u] = [h.borderTopWidth, h.borderLeftWidth, h.borderRightWidth, h.borderBottomWidth].map(s => parseInt(s, 10) || 0);
                return {
                    top: a.top + g,
                    left: a.left + y,
                    width: a.width - T - y,
            ...
            function R(d, t, n, a, {side: h, align: g, allowOutOfBounds: y, anchorOffset: T, alignmentOffset: u}) {
                const s = {top: d.top - t.top, left: d.left - t.left, width: d.width, height: d.height};
                let i = k(n, a, h, g, T, u), f = h, E = g;
                ...
                return Object.assign(Object.assign({}, i), {anchorSide: f, anchorAlign: E})
            }

            c(R, "pureCalculateAnchoredPosition");

            function k(d, t, n, a, h, g) {
                const y = t.left + t.width, T = t.top + t.height;
                let u = -1, s = -1;
            ...
            c(M, "showCheck");
            const R = new WeakMap;
            document.addEventListener("clipboard-copy", function ({target: o}) {
            ...
            var k = I(29501), m = I(75329);
            const v = new WeakMap, d = new WeakMap, t = new WeakMap;

            function n(o) {
                const e = o.currentTarget;
                if (!(e instanceof i)) return;
                const {box: r, image: p} = t.get(e) || {};
                if (!r || !p) return;
                let b = 0, w = 0;
                if (o instanceof KeyboardEvent) o.key === "ArrowUp" ? w = -1 : o.key === "ArrowDown" ? w = 1 : o.key === "ArrowLeft" ? b = -1 : o.key === "ArrowRight" && (b = 1); else if (d.has(e) && o instanceof MouseEvent) {
                    const A = d.get(e);
                    b = o.pageX - A.dragStartX, w = o.pageY - A.dragStartY
                } else if (d.has(e) && o instanceof TouchEvent) {
                    const {pageX: A, pageY: C} = o.changedTouches[0], {dragStartX: $, dragStartY: N} = d.get(e);
                    b = A - $, w = C - N
                }
                if (b !== 0 || w !== 0) {
                ...
                if (o instanceof MouseEvent) d.set(e, {
                    ...
                    const {pageX: A, pageY: C} = o.changedTouches[0];
                    d.set(e, {dragStartX: A, dragStartY: C})
                }
            }
            ...
            function a(o) {
                ...
                if (o instanceof KeyboardEvent) {
                    ...
                    w = p.offsetWidth + C, A = p.offsetHeight + C, v.set(r, {startX: p.offsetLeft, startY: p.offsetTop})
            ...
            function g(o) {
                ...
                if (!p) return;
                const b = o.target;
                if (b instanceof HTMLElement) if (b.hasAttribute("data-direction")) {
                    const w = b.getAttribute("data-direction") || "";
                    r.addEventListener("mousemove", a), r.addEventListener("touchmove", a, {passive: !0}), ["nw", "se"].indexOf(w) >= 0 && r.classList.add("nwse"), ["ne", "sw"].indexOf(w) >= 0 && r.classList.add("nesw"), v.set(r, {
                        startX: p.offsetLeft + (["se", "ne"].indexOf(w) >= 0 ? 0 : p.offsetWidth),
                        startY: p.offsetTop + (["se", "sw"].indexOf(w) >= 0 ? 0 : p.offsetHeight)
                    }), a(o)
                } else r.addEventListener("mousemove", n), r.addEventListener("touchmove", n, {passive: !0})
            }
            ...
            function T(o) {
                const {image: e} = t.get(o) || {};
                if (!e) return;
                const r = Math.round(e.clientWidth > e.clientHeight ? e.clientHeight : e.clientWidth);
                v.set(o, {startX: (e.clientWidth - r) / 2, startY: (e.clientHeight - r) / 2}), y(o, r, r)
            }
            ...
            function s(o, e) {
                ...
                o.dispatchEvent(new CustomEvent("image-crop-change", {bubbles: !0, detail: e}))
            }
...
`;
                    ...
                    }), this.addEventListener("mouseleave", u), this.addEventListener("touchend", u), this.addEventListener("mouseup", u), r.addEventListener("mousedown", g), r.addEventListener("touchstart", g, {passive: !0}), this.addEventListener("keydown", n), this.addEventListener("keydown", a), this.src && (p.src = this.src))
                }

                attributeChangedCallback(e, r, p) {
                    const {image: b} = t.get(this) || {};
            ...
            var E = I(11095), L = I(48030), O = function (o, e, r, p, b) {
    ...
    `
                ...
                connectedCallback() {
                    var e;
                    if (!this.shadowRoot) {
                        const p = this.attachShadow({mode: "open"});
                        p.innerHTML = `
        <style>
          ${this.styles()}
        </style>
      ...
      `
                    ...
                    const {signal: r} = U(this, K, "f");
                    this.addEventListener("mouseleave", this, {signal: r}), this.control.addEventListener("mouseenter", this, {signal: r}), this.control.addEventListener("mouseleave", this, {signal: r}), this.control.addEventListener("focus", this, {signal: r}), this.control.addEventListener("blur", this, {signal: r}), this.ownerDocument.addEventListener("keydown", this, {signal: r}), U(this, G, "m", Q).call(this)
                }
                ...
                attributeChangedCallback(e) {
                    if (e === "id" || e === "data-type") {
                        ...
                        if (this.type === "label") this.control.setAttribute("aria-labelledby", this.id); else {
                            let r = this.control.getAttribute("aria-describedby");
                            r ? r = `${r} ${this.id}` : r = this.id, this.control.setAttribute("aria-describedby", r)
                        }
                    } else if (this.isConnected && e === "hidden") U(this, G, "m", Q).call(this); else if (e === "data-direction") {
            ...
            c(l, "ToolTipElement"), K = new WeakMap, D = new WeakMap, z = new WeakMap, et = new WeakMap, G = new WeakSet, Q = c(function () {
                if (this.hidden) this.classList.remove(nt, ...lt); else {
                ...
                const r = (0, L.N)(this, this.control, {
                    ...
                    align: U(this, D, "f"),
                    anchorOffset: e
                }), p = r.anchorSide, b = r.anchorAlign;
            ...
            function j(k, m = 0, {start: v = !0, middle: d = !0, once: t = !1} = {}) {
                var n = 0, a, h = !1, g = c(function y(...T) {
                    if (!h) {
                        var u = Date.now() - n;
            ...
            function P(k, m = 0, {start: v = !1, middle: d = !1, once: t = !1} = {}) {
                return j(k, m, {start: v, middle: d, once: t})
            }
            ...
            class x extends HTMLElement {
                ...
                connectedCallback() {
                    const m = this.input;
                    if (!m) return;
                    const v = P(B.bind(null, this), 300), d = {check: v, controller: null};
            ...
            async function B(k) {
                const m = k.input;
                if (!m) return;
                const v = k.src, d = k.csrf, t = I.get(k);
                if (!v || !d || !t) {
                ...
                try {
                    ...
                    a.ok ? H(a, m, k.required) : M(a, m, k.required), t.controller = null, m.dispatchEvent(new CustomEvent("auto-check-complete", {bubbles: !0}))
                } catch (a) {
                    a.name !== "AbortError" && (t.controller = null, m.dispatchEvent(new CustomEvent("auto-check-complete", {bubbles: !0})))
                }
            }
            ...
            function M(k, m, v) {
                ...
                m.dispatchEvent(new CustomEvent("auto-check-error", {
                    bubbles: !0,
                    detail: {response: k.clone(), setValidity: t}
            ...
            class j extends HTMLElement {
                ...
                connectedCallback() {
                    ...
                    const f = [x(s, "compositionstart", E => y(this, E)), x(s, "compositionend", E => y(this, E)), x(s, "click", E => k(s, E)), x(s, "change", E => k(s, E)), x(s, "keydown", E => d(s, this, E)), x(s, "toggle", () => _(s, this), {once: !0}), x(s, "toggle", () => S(s)), this.preload ? x(s, "mouseover", () => _(s, this), {once: !0}) : I, ...W(s)];
                    P.set(this, {subscriptions: f, loaded: !1, isComposing: !1})
                }
            ...
            function W(u) {
                let s = !1;
                const i = c(() => s = !0, "onmousedown"), f = c(() => s = !1, "onkeydown"), E = c(() => {
            ...
            function S(u) {
                if (!!u.hasAttribute("open")) for (const s of document.querySelectorAll("details[open] > details-menu")) {
            ...
            function M(u, s) {
                const i = Array.from(u.querySelectorAll('[role^="menuitem"]:not([hidden]):not([disabled]):not([aria-disabled="true"])')),
                    f = document.activeElement, E = f instanceof HTMLElement ? i.indexOf(f) : -1,
                    L = s ? i[E + 1] : i[E - 1], O = s ? i[0] : i[i.length - 1];
                return L || O
            }
            ...
            function v(u, s) {
                ...
                !i || !i.dispatchEvent(new CustomEvent("details-menu-select", {
                    cancelable: !0,
                    detail: {relatedTarget: u}
                })) || (a(u, s), m(u, s), u.getAttribute("role") !== "menuitemcheckbox" && n(s), i.dispatchEvent(new CustomEvent("details-menu-selected", {detail: {relatedTarget: u}})))
            }
            ...
            function d(u, s, i) {
                ...
                switch (i.key) {
                    ...
                    case"Enter": {
                        ...
                        L instanceof HTMLElement && t(L) && L.closest("details") === u && (i.preventDefault(), i.stopPropagation(), L.click())
                    }
                        break
                }
            }
            ...
            function j() {
                const t = /\bWindows NT 6.1\b/.test(navigator.userAgent),
                    ...
                    a = /\bWindows NT 6.3\b/.test(navigator.userAgent), h = /\bFreeBSD\b/.test(navigator.userAgent),
            ...
            function m(t) {
                ...
                if (n.length === 0) t.textContent = B(t.textContent || ""); else if (n.length === 1) {
                    const a = n[0];
            ...
            class S extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "**", suffix: "**", trimFirst: !0})
                }
            }
            ...
            class B extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "_", suffix: "_", trimFirst: !0})
                }
            }
            ...
            class H extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "> ", multiline: !0, surroundWithNewlines: !0})
                }
            }
            ...
            class M extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "`", suffix: "`", blockPrefix: "```", blockSuffix: "```"})
                }
            }
            ...
            class R extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "[", suffix: "](url)", replaceNext: "url", scanFor: "https?://"})
                }
            }
            ...
            class m extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "- ", multiline: !0, unorderedList: !0})
                }
            }
            ...
            class v extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "1. ", multiline: !0, orderedList: !0})
                }
            }
            ...
            class t extends _ {
                constructor() {
                    super();
                    x.set(this, {prefix: "@", prefixSpace: !0})
                }
            }
            ...
            class h extends HTMLElement {
                ...
                connectedCallback() {
                    this.hasAttribute("role") || this.setAttribute("role", "toolbar"), this.addEventListener("keydown", y), this.setAttribute("tabindex", "0"), this.addEventListener("focus", g, {once: !0})
                }
            ...
            function y(l) {
                ...
                if (!(e instanceof HTMLElement)) return;
                const r = P(e), p = r.indexOf(l.target), b = r.length;
                if (p === -1) return;
                let w = 0;
...
`).length > 1
            ...
            function E(l, {text: o, selectionStart: e, selectionEnd: r}) {
                const p = l.selectionStart, b = l.value.slice(0, p), w = l.value.slice(l.selectionEnd);
                if (f === null || f === !0) {
                ...
                if (f && !l.value.slice(0, l.selectionStart).endsWith(o) && (f = !1), !f) {
                    ...
                    l.dispatchEvent(new CustomEvent("input", {bubbles: !0, cancelable: !0}))
                }
...
`);
            ...
            function U(l, o, e, r = !1) {
                if (l.selectionStart === l.selectionEnd) l.selectionStart = s(l.value, l.selectionStart), l.selectionEnd = i(l.value, l.selectionEnd, r); else {
                    const p = l.selectionStart - o.length, b = l.selectionEnd + e.length,
                        w = l.value.slice(p, l.selectionStart) === o, A = l.value.slice(l.selectionEnd, b) === e;
            ...
            function G(l) {
                const o = l.value.slice(0, l.selectionStart), e = l.value.slice(l.selectionEnd), r = o.match(/\n*$/),
                    p = e.match(/^\n*/), b = r ? r[0].length : 0, w = p ? p[0].length : 0;
                let A, C;
                return o.match(/\S/) && b < 2 && (A = u(`
`, 2 - b)), e.match(/\S/) && w < 2 && (C = u(`
`, 2 - w)), A == null && (A = ""), C == null && (C = ""), {newlinesToAppend: A, newlinesToPrepend: C}
            }
            ...
            function K(l, o) {
                ...
                let X = l.value.slice(l.selectionStart, l.selectionEnd), q = T(X) && w.length > 0 ? `${w}
` : p, Y = T(X) && A.length > 0 ? `
${A}` : b;
                if ($) {
                ...
                let F = l.selectionStart, J = l.selectionEnd;
                ...
                if (X.startsWith(q) && X.endsWith(Y)) {
                    ...
                    return {text: V, selectionStart: F, selectionEnd: J}
                } else if (ut) if (N.length > 0 && X.match(N)) {
                    Y = Y.replace(C, X);
                    const V = q + Y;
                    return F = J = F + q.length, {text: V, selectionStart: F, selectionEnd: J}
                } else {
                    const V = q + X + Y;
            ...
            function D(l, o) {
                const {prefix: e, suffix: r, surroundWithNewlines: p} = o;
                let b = l.value.slice(l.selectionStart, l.selectionEnd), w = l.selectionStart, A = l.selectionEnd;
                const C = b.split(`
`);
...
`), p) {
                    const {newlinesToAppend: N, newlinesToPrepend: ot} = G(l);
                    w += N.length, A = w + b.length, b = N + b + ot
                }
                return {text: b, selectionStart: w, selectionEnd: A}
            }
...
`), processed: r
            ...
            function nt(l, o) {
                ...
                let r = l.selectionStart, p = l.selectionEnd;
                O(l);
                const b = l.value.slice(l.selectionStart, l.selectionEnd), [w, A, C] = st(o, b), $ = C.split(`
`).map((q, Y) => `${Q(Y, o.unorderedList)}${q}`), N = $.reduce((q, Y, F) => q + Q(F, o.unorderedList).length, 0),
                ...
                const {newlinesToAppend: Z, newlinesToPrepend: rt} = G(l), X = Z + $.join(`
`) + rt;
            ...
            function W(t, n, a, {multiWord: h, lookBackIndex: g, lastMatchPosition: y} = {
                multiWord: !1,
                lookBackIndex: 0,
...
`, a - 1) > T || t.lastIndexOf(".", a - 1) > T) return
                ...
                const u = t[T - 1];
                return u && !_.test(u) ? void 0 : {text: t.substring(T + n.length, a), position: T + n.length}
            }
            ...
            function M(t, n) {
                ...
                let h = H.get(t);
                if (h && h.parentElement === t.parentElement) h.innerHTML = ""; else {
                    h = document.createElement("div"), H.set(t, h);
                    const u = window.getComputedStyle(t), s = S.slice(0);
                ...
                return h.scrollTop = t.scrollTop, h.scrollLeft = t.scrollLeft, {mirror: h, marker: g}
            }

            c(M, "textFieldMirror");

            function R(t, n = t.selectionEnd) {
                const {mirror: a, marker: h} = M(t, n), g = a.getBoundingClientRect(), y = h.getBoundingClientRect();
                return setTimeout(() => {
                    a.remove()
                }, 5e3), {top: y.top - g.top, left: y.left - g.left}
            }
            ...
            class m {
                ...
                activate(n, a) {
                    ...
                    const {top: y, left: T} = R(this.input, n.position);
                ...
                onCommit({target: n}) {
                    ...
                    this.deactivate(), this.input.focus({preventScroll: !0}), this.input.selectionStart = i, this.input.selectionEnd = i, this.lookBackIndex = i, this.match = null
                }
                ...
                findMatch() {
                    const n = this.input.selectionEnd || 0, a = this.input.value;
                    n <= this.lookBackIndex && (this.lookBackIndex = n - 1);
                    for (const {key: h, multiWord: g} of this.expander.keys) {
                        const y = W(a, h, n, {
                            multiWord: g,
                            lookBackIndex: this.lookBackIndex,
                            lastMatchPosition: this.match ? this.match.position : null
                        });
                        if (y) return {text: y.text, key: h, position: y.position}
                    }
                }

                async notifyProviders(n) {
                    const a = [], h = c(u => a.push(u), "provide");
                    return this.expander.dispatchEvent(new CustomEvent("text-expander-change", {
                        cancelable: !0,
                        detail: {provide: h, text: n.text, key: n.key}
            ...
            class v extends HTMLElement {
                get keys() {
                    const n = this.getAttribute("keys"), a = n ? n.split(" ") : [], h = this.getAttribute("multiword"),
                        g = h ? h.split(" ") : [], y = g.length === 0 && this.hasAttribute("multiword");
                    return a.map(T => ({key: T, multiWord: y || g.includes(T)}))
                }
            ...
            async function x(W, S, B, H) {
                for (let M = 0; M < W.length; M++) {
                    if (B === 0) S.append(W[M]); else for (const R of W[M].split("")) await _(B), S.innerHTML += R;
...
//# sourceMappingURL=vendors-node_modules_github_file-attachment-element_dist_index_js-node_modules_primer_view-co-52e104-58612d26affb.js.map